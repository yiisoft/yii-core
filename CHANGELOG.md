...
- Enh #13799: CAPTCHA rendering logic extracted into `Yiisoft\Yii\Captcha\DriverInterface`, which instance is available via `Yiisoft\Yii\Captcha\CaptchaAction::$driver` field (vladis84, klimov-paul)
...
- Enh #13006: Added a `/` to the `Yiisoft\Yii\Captcha\Captcha::$captchaAction` string to work correctly in a module also (boehsermoe)
