...
Аналогично для [[Yiisoft\Yii\Console\Application|консольных приложений]], контроллеры должны быть унаследованы от [[Yiisoft\Yii\Console\Controller]] или
...
Для [[yii\web\Application|Веб приложений]], это значение `'site'`, в то время как для [[Yiisoft\Yii\Console\Application|консольных приложений]],
...
* Для [[Yiisoft\Yii\Console\Application|Консольных приложений]], возвращаемое значение также может быть числом, представляющим
  [[Yiisoft\Yii\Console\Response::exitStatus|статус выхода]] исполнения команды.
...
для [[Yiisoft\Yii\Console\Application|консольных приложений]], они соответствуют аргументам командной строки.
