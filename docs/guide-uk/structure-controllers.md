...
або його нащадків. Аналогічно для [[Yiisoft\Yii\Console\Application|консольних додатків]], контролери повинні бути
успадкованими від класу [[Yiisoft\Yii\Console\Controller]] або його нащадків. Наступний код визначає контролер `site`:
...
[[Yiisoft\Yii\Console\Application|консольних додатків]], це - `'help'`. Таким чином, якщо вказаний URL 
...
* Для [[Yiisoft\Yii\Console\Application|консольних додатків]], значення, що повертається, також може бути числом, що
  представляє [[Yiisoft\Yii\Console\Response::exitStatus|статус виходу]] виконання команди.
...
для [[Yiisoft\Yii\Console\Application|консольних додатків]] - вони відповідають аргументам командного рядка.
